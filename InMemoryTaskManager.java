...
public class InMemoryTaskManager implements TaskManager {
    ...
    FastInMemoryHistoryManager fastHistory = new FastInMemoryHistoryManager();
    ...
    public void getTasks() {
        if (storageNotEmpty()) {
            ...
            for (Integer key : storage.keySet()) {
                ...
                //history.addTask(storage.get(key));
                fastHistory.addTask(storage.get(key));
            }
        }
    }
    ...
    public void getTaskForId() {
        if (storageNotEmpty()) {
            ...
            if (storage.containsKey(idForTask)) {
                ...
                //history.addTask(storage.get(idForTask));
                fastHistory.addTask(storage.get(idForTask));
            } else {
