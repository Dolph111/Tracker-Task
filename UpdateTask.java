...
import learn.model.Status;
import learn.model.Task;
import learn.model.UpdateTaskMenu;
...
public class UpdateTask {
    ...
    public UpdateTask(InMemoryTaskManager manager) {
    ...
    public void updateTask() {
        ...
        while (isRunning) {
            if (!manager.storage.containsKey(currentCommand)) {
                ...
                System.out.println("Пожалуйста, выберите задачу с существующим ID");
                getNextCommand();
            } else {
                isRunning = false;
            }
